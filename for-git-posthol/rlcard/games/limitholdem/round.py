...
class LimitHoldemRound:
    ...
    def proceed_round(self, players, action):
        ...
        if action == 'call':
            ...
            # print("player", players[self.game_pointer].player_id, "called, increasing chips by", diff, "to", max(self.raised))
            ...
            # print("player", players[self.game_pointer].player_id, "raised, increasing chips by", diff, "to", players[self.game_pointer].in_chips)

        elif action == 'fold':
            players[self.game_pointer].status = 'folded'
            self.player_folded = True
            # print("player", players[self.game_pointer].player_id, "folded")

        elif action == 'check':
            self.not_raise_num += 1
            # print("player", players[self.game_pointer].player_id, "checked")
