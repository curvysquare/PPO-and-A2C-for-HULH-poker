...
try: from stable_baselines3.common.preprocessing import check_for_nested_spaces, is_image_space_channels_first
except ModuleNotFoundError: from preprocessing_mod import check_for_nested_spaces, is_image_space_channels_first
